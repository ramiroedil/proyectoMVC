...
<div class="col-xxl">
    <div class="card mb-4">
        <div class="card-header d-flex align-items-center justify-content-between bg-warning text-dark">
            <h5 class="mb-0"><i class="fas fa-cash-register"></i> Registro de Cajero</h5>
            <small>Complete el formulario</small>
        </div>
        <div class="card-body">
            <form method="POST" action="../controlador/usuarioCajeroRegistro.php">
                <div class="row mb-3">
